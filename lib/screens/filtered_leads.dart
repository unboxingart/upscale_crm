...
class FilteredLeads extends StatefulWidget {
  User? user = FirebaseAuth.instance.currentUser;
  String leadStage = '';
  FilteredLeads(this.user, this.leadStage, {Key? key}) : super(key: key);

  @override
  _FilteredLeadsState createState() => _FilteredLeadsState();
}

class _FilteredLeadsState extends State<FilteredLeads> {
  ...
  Future<void> fetchFilteredLeads() async {
    ...
    await FirebaseFirestore.instance
        ...
        .where("stage", isEqualTo: widget.leadStage)
